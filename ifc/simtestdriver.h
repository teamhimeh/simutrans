...
public:
	...
	virtual bool check_next_tile(const grund_t* bd, const linehandle_t ) const { return check_next_tile(bd); }
	...
	virtual bool is_coupling_target(const grund_t *, const grund_t *, const linehandle_t, sint16 &) const { return 0; }
