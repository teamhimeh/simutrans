...
void way_obj_reader_t::register_obj(obj_desc_t *&data)
{
	...
	desc->diagonals = (desc->get_front_diagonal_image_id(ribi_t::northeast) != IMG_EMPTY || desc->get_back_diagonal_image_id(ribi_t::northeast) != IMG_EMPTY);
	desc->close_diagonals = (desc->get_front_close_diagonal_image_id(0) != IMG_EMPTY || desc->get_back_close_diagonal_image_id(0) != IMG_EMPTY);
