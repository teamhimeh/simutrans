...
public:
	...
	*/
	...
	virtual bool calc_route(koord3d start, koord3d ziel, sint32 max_speed, route_t* route, std::function<void()> int_check);
...
public:
	...
	bool calc_route(koord3d start, koord3d ziel, sint32 max_speed, route_t* route, std::function<void()> int_check) OVERRIDE;
